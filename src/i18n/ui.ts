...
const de = {
  ...
  chair: {
    ...
    detailed: 'Ginstergelber Schulstuhl von VS (schematische Darstellung)',
  },
  services: {
  ...
  quotes: {
    pendingAuthor: 'Name · Funktion · Schule / Gemeinde',
    pendingProject: (project: string) => `Zitat folgt nach Freigabe (${project})`,
    pendingClosing: 'Zitat folgt nach Freigabe',
  ...
  people: {
    ...
    portraitPending: 'Portrait folgt',
    portraitLabel: (name: string) => `Platzhalter für das Portrait von ${name}`,
    lastNamePending: 'Nachname folgt',
    rolePending: 'Rolle / Zuständigkeit folgt',
    phonePending: 'Telefon folgt',
  ...
  form: {
    ...
    status: {
      ...
      mailto: 'Ihr E-Mail-Programm öffnet eine vorbereitete Nachricht an {email}. Bitte dort absenden.',
...
const it: UI = {
  ...
  chair: {
    ...
    detailed: 'Sedia scolastica VS in giallo ginestra (rappresentazione schematica)',
  },
  services: {
  ...
  quotes: {
    pendingAuthor: 'Nome · Ruolo · Scuola / Comune',
    pendingProject: (project: string) => `Citazione in arrivo dopo l’approvazione (${project})`,
    pendingClosing: 'Citazione in arrivo dopo l’approvazione',
  ...
  people: {
    ...
    portraitPending: 'Ritratto in arrivo',
    portraitLabel: (name: string) => `Segnaposto per il ritratto di ${name}`,
    lastNamePending: 'Cognome in arrivo',
    rolePending: 'Ruolo / competenze in arrivo',
    phonePending: 'Telefono in arrivo',
  ...
  form: {
    ...
    status: {
      ...
      mailto: 'Il vostro programma di posta apre un messaggio già pronto per {email}. Inviatelo da lì.',
  ...
  footer: {
    ...
    privacy: 'Privacy',
    phonePending: 'Telefono in arrivo',
    addressPending: 'Indirizzo in arrivo',
